    ...
    public class DataSeeding(AppDbContext _dbContext) : IDataSeeding
    {
        public void SeedData()
        {
            ...
            if (!_dbContext.Customers.Any())
            {
                ...
                var CustomersData = File.ReadAllText("..\\Restaurant.DAL\\DataSeeding\\JsonFiles\\Customers.json");
            ...
            if (!_dbContext.Tables.Any())
            {
                ...
                var TablesData = File.ReadAllText("..\\Restaurant.DAL\\DataSeeding\\JsonFiles\\Tables.json");
            ...
            if (!_dbContext.Orders.Any())
            {
                ...
                var OrdersData = File.ReadAllText("..\\Restaurant.DAL\\DataSeeding\\JsonFiles\\Orders.json");
